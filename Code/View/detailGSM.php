                            ...
                            if($gsm->data)
                            {
                                ...
                                foreach ($gsm->data as $key=>$values)
                                {
                                    if($id === $values->id_gsm)
                                    {
                                        ...
                                        if(($_SESSION['typeCompte'] == 2) || ($_SESSION['typeCompte'] == 3))
                                        {
                                        ...
                                        echo '<th colspan="2"><div class="text-center"></br>
                                                <button><a class="add addpanier" href="../Controller/ajoutPanier.php?idGSM='.$values->id_gsm.'">
                                                <i class="bi bi-cart-plus"></i> Ajouter au Panier</a></button></div></th>';
                                        /*
                                        echo '<th colspan="2"><div class="text-center"></br>';

...
// page avec les erreurs
    ...
    switch ($erreur)
    {
        ...
        case 5: echo'<div class="alert alert-danger alert-dismissible fade show" role="alert"><button type="button" class="close" data-dismiss="alert">&times;</button>Vous essayer de créer un nouveau modèles ou marque. Aller dans la section ajout GSM.</div>'; break;
